            ...
            <ul class="navbar-nav ml-auto">
                ...
                @foreach($parentMenus->sortBy('id') as $rs)
                    ...
                    <li class="nav-item dropdown" style="margin-right: 10px;">
                        <a class="nav-link" href="#" id="navbarDropdownBlog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: white;"> <div class="hover-item">{{$rs->title}} <i style="margin-left: 5px;" class="fas fa-sort-down"></i></div></a>
